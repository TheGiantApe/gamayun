...
const GAMA = (() => {
  ...
  const TOOL_LINES = {
    ...
    PICK_ONE: [
      ...
      "> spun. the wheel decided. don't blame me, i just logged the spin.",
      "> picked. the decision your group chat couldn't make in twenty minutes, made in one.",
      "> picked. something to watch. the arguing about it is still on you.",
      "> chosen. the list isn't shorter, but the deciding part is done.",
      "> drawn. a winner, selected. the raffle gods remain unbribable.",
    ],
    ...
    RHYME_FINDER: ["> matched. spelling, not sound - say it out loud before you trust it."],
